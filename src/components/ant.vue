  ...
  <div> 
    <v-container>
      ...
      <v-row>
        ...
        <v-col>
          <v-card class="v1" outlined color="transparent">
            ...
            >
              <v-progress-linear color="#FF00AA" :height="150" v-model="pPan" style="pointer-events: none">
                <template>
                  <!-- <strong>{{ Math.ceil(value) }}</strong> -->
      ...
      <v-row>
        ...
        <p class="f1 font-weight-black">{{data.gcs_ip.split('.')[0] + '.' + data.gcs_ip.split('.')[1] + '.' + data.gcs_ip.split('.')[2] + '.100'}}</p>
        ...
        <v-col>
          <v-card class="v1" outlined color="transparent">
            ...
            >
              <v-progress-linear color="#AAFF00" :height="150" v-model="nTilt" style="pointer-events: none">
                <template>
                  <!-- <strong>{{ Math.ceil(value) }}</strong> -->
